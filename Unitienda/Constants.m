...
static NSString* LABEL_NAME_PROFILE_CREATOR_UPDATER_RESPONSE = @"profileCreatorUpdaterResponse";
static NSString* LABEL_NAME_PROFILE_STORE_RESPONSE = @"profileCheckerResponse";
static NSString* LABEL_NAME_PROFILE_CREATOR_UPDATER_RESPONSE_NOTIFICATION = @"profileCreatorUpdaterResponseNoticication";
...
+(NSString *) GET_LABEL_NAME_PROFILE_CREATOR_UPDATER_RESPONSE{
    return LABEL_NAME_PROFILE_CREATOR_UPDATER_RESPONSE;
}
...
+(NSString *) GET_LABEL_NAME_PROFILE_CREATOR_UPDATER_RESPONSE_NOTIFICATION{
    return LABEL_NAME_PROFILE_CREATOR_UPDATER_RESPONSE_NOTIFICATION;
}
...
/****************************************************************
 PROMOTION CONSTANTS
 ****************************************************************/
static NSString* LABEL_NAME_PROMOTIONS_BY_STORE_WS_RESPONSE_NOTIFICATION = @"promotionsByStoreWsResponseNotification";
static NSString* LABEL_NAME_PROMOTIONS_BY_STORE_WS_RESPONSE = @"promotionsByStoreWsResponse";

static NSString* LABEL_NAME_PROMOTIONS_BY_STORE_DATASYNC_RESPONSE_NOTIFICATION = @"promotionsByStorePersistenceResponseNotification";
static NSString* LABEL_NAME_PROMOTIONS_BY_STORE_DATASYNC_RESPONSE = @"promotionsByStorePersistenceResponse";

static NSString* LABEL_NAME_EDIT_PROMOTION_WS_RESPONSE_NOTIFICATION = @"editPromotionWsResponseNotification";
static NSString* LABEL_NAME_EDIT_PROMOTION_WS_RESPONSE = @"editPromoitonResponse";


+(NSString *) GET_LABEL_NAME_PROMOTIONS_BY_STORE_WS_RESPONSE_NOTIFICATION{
    return LABEL_NAME_PROMOTIONS_BY_STORE_WS_RESPONSE_NOTIFICATION;
}

+(NSString *) GET_LABEL_NAME_PROMOTIONS_BY_STORE_WS_RESPONSE{
    return LABEL_NAME_PROMOTIONS_BY_STORE_WS_RESPONSE;
}

+(NSString *) GET_LABEL_NAME_EDIT_PROMOTION_RESPOSNE_NOTIFICATION{
    return LABEL_NAME_EDIT_PROMOTION_WS_RESPONSE_NOTIFICATION;
}

+(NSString *) GET_LABEL_NAME_EDIT_PROMOTION_RESPOSNE{
    return LABEL_NAME_EDIT_PROMOTION_WS_RESPONSE;
}
